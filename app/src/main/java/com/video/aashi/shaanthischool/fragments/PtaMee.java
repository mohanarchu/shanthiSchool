...
public class PtaMee extends Fragment
{
   ...
   Paidadapters paidadapters;
    ...
    List<com.video.aashi.shaanthischool.adapters.arrar_adapterd.Memos> lists= new ArrayList<>();
    boolean click = false;
    @Override
                       ...
                       try {
                           ...
                           if (list.length() != 0)
                           {
                               ...
                               for (int i = 0; i < list.length(); i++)
                               {
                                   ...
                                   lists.add(new com.video.aashi.shaanthischool.adapters.arrar_adapterd.Memos(date,validdate,inference,
    ...
    class Paidadapters extends RecyclerView.Adapter<Memos.Viewholder> {
        ...
        List<com.video.aashi.shaanthischool.adapters.arrar_adapterd.Memos> list;
        Context context;
        ...
        public Paidadapters(List<com.video.aashi.shaanthischool.adapters.arrar_adapterd.Memos> adapters, Context context)
        {
