...
public class LoginAttempt extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        retrofits = new Retrofit.Builder().baseUrl(APIUrl.MAIN_URL ).
                addConverterFactory
      ...
      //  new RequestOtp().execute();
        ...
        login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    s = new Retrofit.Builder().baseUrl(APIUrl.MAIN_URL).
                            addConverterFactory
                                    (GsonConverterFactory.create())
                            .client(clients)
                            .build();
                ...
                else
                {
                    ...
                    {
                        mobileNum.setError("Field is empty");
                    }
    ...
    public class LoginTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            Call<ResponseBody> call = loginInterfaces.getLogin
                    (new com.video.aashi.shaanthischool.adapters.post_class.Login(mobileNum.getText().toString(),
                            pinLogin.getText().toString()));
                    ...
                    try {
                        ...
                        try {
                            ...
                            if (errorMessage.contains("Invalid pin") ) {
                                ...
                                editor.putString("mobileNo",mobileNum.getText().toString());
                                editor.apply();
                                progressDialog.dismiss();
                                if (count == 0) {
                                    DeviceImei();
                            ...
                            else if (errorMessage.contains("Invalid Mobile No") )
                            {
                            ...
                            else
                            {
                                ...
                                if (multipleLogin.contains("Y"))
                                {
                                    ...
                                    editor.putString("loginId",users);
                                    editor.putString("mobileNo",mobileNum.getText().toString());
                                    editor.apply();
                                    SharedPreferences settings = getSharedPreferences("com.example.xyz", 0);
                                    SharedPreferences.Editor editor = settings.edit();
                                    ...
                                    intent.putExtra("mobileNo",mobileNum.getText().toString());
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions,
        ...
        class ImeiValidate extends AsyncTask {
            ...
            protected Object doInBackground(Object[] objects) {
                ...
                Call<ResponseBody> call  =   loginInterfaces.getImei(new
                        Imei(sharedPreferences.getString("mobileNo","")
                        ,imeis));
    ...
    class RequestOtp extends AsyncTask
    {
        ...
        protected Object doInBackground(Object[] objects) {
            ...
            Call<ResponseBody> respons = myInterface.otpGeneration(new OtpGeneration(
                  mobile  ));
