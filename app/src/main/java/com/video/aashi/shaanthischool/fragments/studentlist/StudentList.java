package com.video.aashi.shaanthischool.fragments.studentlist;
...
public class StudentList extends AppCompatActivity {
    ...
    String session,parentPin,loginId,mobileNo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       //    sharedPreferences = getApplicationContext().getSharedPreferences(MainActivity.PREF_NAME,MODE_PRIVATE);
        ...
        mobileNo = loginCredit.getString("mobileNo","");
        ...
        retrofit = new Retrofit.Builder().baseUrl(url+"rest/ShaanthiMobileAppWS/").addConverterFactory
    ...
    public  class  getStudent extends AsyncTask
    {
        ...
        protected Object doInBackground(Object[] objects) {
            ...
            jsonObject.addProperty("pin",parentPin);
            jsonObject.addProperty("mobSession",session);

            Call<ResponseBody> call = myInterfacee.getStudentList(new
                    com.video.aashi.shaanthischool.adapters.post_class.StudentList(
                   mobileNo,parentPin,session));
             ...
             //   students.get(position).getImage().equals("");
                ...
                holder.mystudent.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        editor2.putString("session",studentss.getSessions());
